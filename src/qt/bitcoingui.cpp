    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("RadioShares") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RadioShares address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About RadioShares"), this);
    aboutAction->setStatusTip(tr("Show information about RadioShares"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for RadioShares"));
   ...
   // miningOffAction->setMenuRole(QAction::PreferencesRole);
    ...
    miningOneAction->setStatusTip(tr("Mine RadioShares with 1 process. 1GB Required. Program may crash if insufficient memory is available."));
   // miningOneAction->setMenuRole(QAction::PreferencesRole);
    ...
    miningTwoAction->setStatusTip(tr("Mine RadioShares with 2 processes. 1.75GB Required. Program may crash if insufficient memory is available."));
   // miningTwoAction->setMenuRole(QAction::PreferencesRole);
    ...
    miningThreeAction->setStatusTip(tr("Mine RadioShares with 3 processes. 2.5GB Required. Program may crash if insufficient memory is available."));
   // miningThreeAction->setMenuRole(QAction::PreferencesRole);
    ...
    miningFourAction->setStatusTip(tr("Mine RadioShares with 4 processes. 3.25GB Required. Program may crash if insufficient memory is available."));
   // miningFourAction->setMenuRole(QAction::PreferencesRole);
    
    signMessageAction = new QAction(QIcon(":/icons/edit"), tr("Sign &message..."), this);
    signMessageAction->setStatusTip(tr("Sign messages with your RadioShares addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RadioShares addresses"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("RadioShares client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RadioShares network", "", count));
}
...
void BitcoinGUI::setMining(double hashrate, int threads)
{
    ...
    else
    {
        ...
        labelMiningIcon->setToolTip(tr("Not mining RadioShares"));
    }
}

void BitcoinGUI::message(const QString &title, const QString &message, unsigned int style, bool *ret)
{
    QString strTitle = tr("RadioShares"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid RadioShares address or malformed URI parameters."),
